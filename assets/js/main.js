    ...
    function documentReadyInit() {
        ...
        $('form.contact-form').on('submit', function (e) {
            ...
            var ajax = jQuery.post("contact-form.php", request)
                .done(function (data) {
                    $($form).find('[type="submit1"]').attr('disabled', false).parent().append('<div class="contact-form-respond color-main mt-20">' + data + '</div>');
                    //cleaning form
                ...
                .fail(function (data) {
                    $($form).find('[type="submit1"]').attr('disabled', false).blur().parent().append('<div class="contact-form-respond color-main mt-20">Mail cannot be sent. You need PHP server to send mail.</div>');
                })
        });
